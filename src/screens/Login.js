              ...
              <View style={styles.inputWrap}>
                <View style={styles.btn}>
                  {_this.state.loading ? (
                    ...
                    <TouchableOpacity
                      activeOpacity={0.8}
                      style={[styles.btn_l, { backgroundColor: "#6b99e1" }]}
                      onPress={() => {
                        _this._doLogin();
                      }}
                    >
                      <Text style={styles.btnText}>
                        <Translation str="sign_in" />
                      </Text>
                    </TouchableOpacity>
                  )}
                </View>
                ...
                <View>
                  ...
                  >
                    <Text style={styles.btnText}>
                      <Translation str="sign_up" />
                    </Text>
                  </TouchableOpacity>
                </View>
                <View style={styles.termPrivacy}>
                  <Text style={styles.termPrivacyText}>
                    <Translation str="by_creating" />{" "}
                    <Text
                      style={styles.termPrivacyTextLink}
                      onPress={() => {
                        console.log(1);
                      }}
                    >
                      <Translation str="terms_conditions" />
                    </Text>{" "}
                    <Translation str="and" />{" "}
                    <Text
                      style={styles.termPrivacyTextLink}
                    ...
                    >
                      {" "}
                      <Translation str="privacy_statement" />
                    </Text>
                  </Text>
                </View>
              </View>
