...
export default class AddACarStepTwo extends React.Component {
  ...
  async componentWillMount() {
    ...
    let apiKeyIos = "";
    if (
      _this.props.navigation.state.params.step_two.hasOwnProperty("location")
    ) {
      try {
                  ...
                  case "seller_notes":
                    return (
                      <View key={index} style={styles.addMediaWrap}>
                        <Text style={styles.filterMediaLabel}>
                      ...
                      >
                        <View style={styles.multiPicker}>
                          ...
                          <View style={styles.checkedItems}>
                            {addACarData.hasOwnProperty("stm_s_s_make") &&
                            Object.keys(addACarData.stm_s_s_make).length > 0 ? (
                              _.map(
                                addACarData["stm_s_s_make"],
                                function (val, slug) {
                                  return (
                                    <TouchableOpacity
                                      activeOpacity={0.8}
                    ...
                    return (
                      ...
                      >
                        <View style={styles.multiPicker}>
                          ...
                          <View style={styles.checkedItems}>
                            {addACarData.hasOwnProperty("stm_s_s_body") &&
                            Object.keys(addACarData.stm_s_s_body).length > 0 ? (
                              _.map(
                                addACarData["stm_s_s_body"],
                                function (val, slug) {
                                  return (
                                    <TouchableOpacity
                                      activeOpacity={0.8}
                      ...
                      <View key={index} style={styles.multiPicker}>
                        ...
                        <View style={styles.inputWrap}>
                          <TextInput
                            ...
                            defaultValue={
                              addACarData.hasOwnProperty("stm_s_s_mileage")
                                ? addACarData["stm_s_s_mileage"]
                                : ""
                            }
                          />
                      ...
                      <View key={index} style={styles.multiPicker}>
                        ...
                        <View style={styles.inputWrap}>
                          <TextInput
                            ...
                            defaultValue={
                              addACarData.hasOwnProperty("stm_s_s_engine")
                                ? addACarData["stm_s_s_engine"]
                                : ""
                            }
                          />
                        </View>
                    ...
                    return (
                      ...
                      >
                        <View style={styles.multiPicker}>
                          ...
                          <View style={styles.checkedItems}>
                            {addACarData.hasOwnProperty("stm_s_s_" + index) &&
                            Object.keys(addACarData["stm_s_s_" + index])
                              .length > 0 ? (
                              _.map(
                                addACarData["stm_s_s_" + index],
                                function (val, slug) {
                                  return (
                                    <TouchableOpacity
                                      activeOpacity={0.8}
