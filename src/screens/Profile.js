...
import verifyImage from "../assets/img/verifyBadge.png";
...
export default class Profile extends React.Component {
      ...
      _this.setState(
        {
          ...
          listingsData: responceJSON.hasOwnProperty("listings")
            ? responceJSON.listings
            : {},
          favouritesData: responceJSON.hasOwnProperty("favourites")
            ? responceJSON.favourites
            : {},
        },
        function () {}
      );
  ...
  onPress = () => {
    ...
    _this.props.navigation.navigate("Subscription");
  };
  ...
  _goToEditCar = () => {
    this.props.navigation.navigate("AddACarStepOne", {
      editMode: true,
      listingId: popupObj.ID,
    });
  ...
  _loadMore = () => {
    let params =
      ...
      _this.state.userId +
      "&limit=" +
      _this.state.invLimit +
      "&offset=" +
      _this.state.invOffset;
  ...
  _loadMoreFavourites = () => {
    let params =
      ...
      _this.state.userId +
      "&limit=" +
      _this.state.favLimit +
      "&offset=" +
      _this.state.favOffset;

    loadMoreFavourites(params).then((responseJson) => {
      _this.setState({
        favouritesFound: responseJson.favourites_found,
        favouritesData: _this.state.favouritesData.concat(
          responseJson.favourites
        ),
        favLimit: responseJson.limit,
        favOffset: responseJson.offset,
        loadData: false,
  ...
  render() {
    ...
    const editIco = (
      <Ico icoName="lnr-menu" icoColor={GLOBALS.COLOR.gray88} icoSize={30} />
    );
      ...
      <View style={styles.container}>
        ...
        >
          <View style={styles.wrap}>
            <View style={styles.userInfo}>
              ...
              <View style={{ flexDirection: "row" }}>
                ...
                {this.state.listingsData.length > 0 && (
                  <Image
                    source={verifyImage}
                    style={{
                      width: 20,
            ...
            {_this.state.appType != "dealership" ? (
              <View style={styles.authorInfoWrap}>
                ...
                >
                  <View
                    style={[styles.callBtn, { backgroundColor: "#6b99e1" }]}
                  >
                    <Ico
          ...
          <View style={{ width: "100%", alignItems: "center" }}>
            {this.state.listingsData.length == 0 && (
              <Btn text={"Subscribe To Plan"} onPress={() => _this.onPress()} />
            )}
          </View>
          <View style={styles.inventoryWrap}>
            <Text style={styles.mainTitle}>
              <Translation str="my_inventory" />
            </Text>
            {Object.keys(_this.state.listingsData).length > 0 ? (
              ...
              <Text style={{ textAlign: "center" }}>
                <Translation str="inventory_empty" />
              </Text>
            )}
          </View>
          <View style={styles.inventoryWrap}>
            <Text style={styles.mainTitle}>
              <Translation str="my_favourites" />
            </Text>
            {_this.state.favouritesData != null &&
            Object.keys(_this.state.favouritesData).length > 0 ? (
              <FlatList
                style={styles.flatStyle}
              ...
              <Text style={{ textAlign: "center", marginTop: 20 }}>
                <Translation str="favourites_empty" />
              </Text>
            )}
          </View>
        </ScrollView>
          ...
          >
            ...
            <View style={styles.wrapper}>
              <View>
                ...
                >
                  <Text style={styles.price}>{popupObj.price}</Text>
                </View>
              </View>
                ...
                <View style={styles.InfoMainWrap}>
                  <View style={styles.infoWrap}>
                    ...
                    <View>
                      ...
                      <Text style={styles.infoDataBottomWrap} numberOfLines={1}>
                        {popupObj.descOne}
                      </Text>
                    </View>
                  </View>
