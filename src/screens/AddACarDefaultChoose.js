...
export default class AddACarDefaultChoose extends React.Component {
      ...
      headerTitle: (
        <View style={styles.appMainTitle}>
          <Text style={styles.center}>
            <Translation str="choose" /> {navigation.state.params.title}
          </Text>
        </View>
      ),
      headerLeft: (
  ...
  async componentWillMount() {
    ...
    if (
      (_this.props.navigation.state.params.filterType == "serie" &&
        typeof _this.props.navigation.state.params.checkedParams.stm_f_s_make !=
          "undefined") ||
      typeof _this.props.navigation.state.params.checkedParams.stm_s_s_make !=
        "undefined"
    ) {
      if (
        typeof _this.props.navigation.state.params.checkedParams.stm_s_s_make !=
        ...
        _this._updateFilterParams(
          _this.props.navigation.state.params.checkedParams.stm_s_s_make,
          _this.props.navigation.state.params.filterData
        );
      } else {
        _this._updateFilterParams(
          _this.props.navigation.state.params.checkedParams.stm_f_s_make,
          _this.props.navigation.state.params.filterData
        );
      }
              ...
              onPress={() => {
                if (!checked.hasOwnProperty(_this.state.filterType)) {
                  ...
                  if (
                    ...
                    delete checked[_this.state.filterType][
                      _this.state.oldChecked
                    ];
                    checked[_this.state.filterType][item.slug] = item.label;
                  } else {
            ...
            >
              {item.slug != _this.state.oldChecked ? (
                <View style={styles.listItem}>
                  <Text
                    style={[styles.title, { color: _this.state.secondColor }]}
                  >
                    {item.label}
                  </Text>
