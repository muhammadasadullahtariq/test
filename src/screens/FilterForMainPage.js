...
export default class Filter extends React.Component {
  ...
  async componentWillMount() {
    ...
    getFilter().then((responceJSON) => {
      ...
      _this.setState(
        ...
        function () {
          let newObject = {};
          var o = _this.state.filterData;
          delete Object.assign(newObject, o, { ["Model"]: o["serie"] })[
            "serie"
          ];
          let obj = { make: null, Model: null, year: null };
          newObject = Object.assign(obj, newObject);
          _this.setState({ filterData: newObject });
  ...
  _btnOnPress = () => {
    _this.props.navigation.navigate("Inventory", {
      filter_data: parammsForFilter,
    });
  };
  ...
  render() {
    ...
    let price =
      typeof _this.state.filterData.price != "undefined"
        ? _this.state.filterData.price
        : null;
    let year =
      typeof _this.state.filterData.year != "undefined"
        ? _this.state.filterData.year
        : null;
                ...
                switch (index) {
                  case "make":
                    return (
                      <TouchableOpacity
                        activeOpacity={0.8}
                        onPress={() => {
                          navigate("FilterMakeChoose", {
                            makesData: _this.state.maker,
                  ...
                  case "year":
                    return (
                      <View key={index} style={styles.selectsWrap}>
                        ...
                        <View style={styles.customSelectWrap}>
                          <FilterSelect
                            filterSelectOpt={fromPlchldr}
                  ...
                  default:
                    return (
                      ...
                      >
                        <View key={index} style={styles.multiPicker}>
                          <Text style={styles.filterLabel}>{index}</Text>
                          <View style={styles.checkedItems}>
                            {typeof parammsForFilter[index] != undefined
                              ? _.map(
                                  parammsForFilter[index],
                                  function (val, slug) {
                                    return (
                                      <TouchableOpacity
                                        activeOpacity={0.8}
