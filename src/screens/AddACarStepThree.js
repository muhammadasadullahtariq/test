...
export default class AddACarStepThree extends React.Component {
  ...
  _btnOnPress = () => {
    console.log("price\t" + validateFields.price);

    if (_this.state.carPrice > 1000) {
      _this._showToast("Please enter Price less than 1000");
      return;
    }
    ...
    formData.append("security", "1bea47a6b6");
    formData.append("btn-type", "add");
    formData.append("action", "stm_ajax_add_a_car");
    formData.append("stm_f_s[condition]", "used-cars");
                ...
                switch (index) {
                  ...
                  case "stm_additional_features":
                    ...
                    return (
                      <View key={index} style={styles.addMediaWrap}>
                        <Text style={styles.filterMediaLabel}>
                          <Translation str="select_your_car_features" />
                        </Text>
                        <FlatList
                              ...
                              {addACarData[
                                ...
                                <View
                                  style={[
                                    ...
                                    { borderColor: _this.state.mainColor },
                                  ]}
                                >
                                  <Text
                                    style={[
                      ...
                      >
                        <View style={styles.multiPicker}>
                          ...
                          <View style={styles.checkedItems}>
                            {addACarData.hasOwnProperty("make") &&
                            Object.keys(addACarData.make).length > 0 ? (
                    ...
                    return (
                      ...
                      >
                        <View style={styles.multiPicker}>
                          ...
                          <View style={styles.checkedItems}>
                            {addACarData.hasOwnProperty("body") &&
                            Object.keys(addACarData.body).length > 0 ? (
                      ...
                      <View key={index} style={styles.multiPicker}>
                        ...
                        <View style={styles.inputWrap}>
                          <TextInput
                            ...
                            defaultValue={
                              addACarData.hasOwnProperty("mileage")
                                ? addACarData["mileage"]
                                : ""
                            }
                          />
                      ...
                      <View key={index} style={styles.multiPicker}>
                        ...
                        <View style={styles.inputWrap}>
                          <TextInput
                            ...
                            defaultValue={
                              addACarData.hasOwnProperty("engine")
                                ? addACarData["engine"]
                                : ""
                            }
                          />
                    ...
                    return (
                      ...
                      >
                        <View style={styles.multiPicker}>
                          ...
                          <View style={styles.checkedItems}>
                            {addACarData.hasOwnProperty(index) &&
                            Object.keys(addACarData[index]).length > 0 ? (
