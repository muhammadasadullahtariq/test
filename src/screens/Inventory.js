...
export default class Inventory extends React.Component {
  ...
  _loadListings = () => {
    if (_this.state.limit != 0 && _this.state.offset != 0) {
      ...
      getFilteredListings(_this.buildQuery(_this.state.limit)).then(
        (responceJSON) => {
          _this.setState(
            {
              isLoading: false,
              loadMore: false,
              dataListings: _this.state.dataListings.concat(
    ...
    return (
      <View style={styles.container}>
        <Search
          ...
          dataListings={this.state.dataListings}
          inventoryView={this.state.inventoryView}
          _footerComponent={_this._footerComponent}
          _deleteFilterParam={_this._deleteFilterParam}
          navigation={this.props.navigation}
          _loadListings={this._loadListings}
        />
