  ...
  render() {
    ...
    return (
      <TouchableOpacity
        ...
        style={[
          styles.svgStyle,
          _this.state.activeBtn
            ? {
                backgroundColor: "#6b99e1",
                borderColor: _this.state.secondColor,
              }
            : "",
        ]}
        onPress={onPress}
      >
        <View style={{ alignItems: "center" }}>
          ...
          <Ico
            icoName="lnr-menu"
            icoColor={
              _this.state.activeBtn ? GLOBALS.COLOR.white : GLOBALS.COLOR.gray88
            }
            icoSize={16}
          />
          <Menu
            style={[styles.menuSt, { backgroundColor: "#6b99e1" }]}
            ref={setMenuRef}
            onHidden={onHdn}
          >
            <MenuItem
              textStyle={{ color: GLOBALS.COLOR.white }}
              onPress={() => {
                hideMenu();
                this.props.navigation.navigate("Profile");
              }}
              disabled={this.state.currPage == "profile" ? true : false}
            >
              <Translation str="my_account" />
            </MenuItem>
            <MenuItem
              textStyle={{ color: GLOBALS.COLOR.white }}
              onPress={() => {
              ...
              disabled={this.state.currPage == "edit_profile" ? true : false}
            >
              <Translation str="edit_account" />
            </MenuItem>
            <MenuItem
              textStyle={{ color: GLOBALS.COLOR.white }}
              onPress={() => {
