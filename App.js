...
import Subscription from "./src/screens/SubscriptionPlan";
import SubscriptionDetail from "./src/screens/SubscriptionDetail";
import { EventRegister } from "react-native-event-listeners";
import Paypal from "./src/screens/paypal";
import firebase, {
  RemoteMessage,
  Notification,
  NotificationOpen,
...
class App extends React.Component {
  ...
  render() {
    if (translateObj == null) {
      return (
        <ImageBackground
          source={require("./src/assets/img/Splash.jpeg")}
